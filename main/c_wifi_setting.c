...
static const char *g_wifi_ssid = "H3C1";
static const char *g_wifi_password = "bjlg2023";
...
static void nvs_get_sta(char *ssid, char *password)
{
    ...
    else
    {
        ...
        case ESP_OK:
            ...
            {
                if (strcmp(ssid, g_wifi_ssid) != 0)
                {
                    printf("Wifi ssid set: %s\n", g_wifi_ssid);
                    nvs_set_str(my_handle, "wifi_name", g_wifi_ssid);
                    strcpy(ssid, g_wifi_ssid);
                }
                if (strcmp(password, g_wifi_password) != 0)
                {
                    printf("Wifi password set: %s\n", g_wifi_password);
                    nvs_set_str(my_handle, "wifi_password", g_wifi_password);
                    strcpy(password, g_wifi_password);
                }
            }
            printf("Done\n");
